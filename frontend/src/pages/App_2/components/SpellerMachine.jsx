...
//       // Check two-letter symbols first
//       if (remaining.length >= 2) {
//         const twoLetters = remaining.slice(0, 2);
//         const element = periodicElements.find(
//           (e) => e.symbol.toLowerCase() === twoLetters
//         );
//         if (element) {
//           results.push({
...
//       // Single letter match or special
//       const oneLetter = remaining[0];
//       if (specialElements[oneLetter]) {
//         results.push(specialElements[oneLetter]);
//         matched = true;
//       } else {
//         const element = periodicElements.find(
//           (e) => e.symbol.toLowerCase() === oneLetter
//         );
//         if (element) {
//           results.push({
//             symbol: element.symbol,
...
//       // If not matched, fallback to gray placeholder
//       if (!matched) {
//         results.push({
//           symbol: oneLetter.toUpperCase(),
//           atomicNumber: "-",
//           fullName: oneLetter.toUpperCase(),
//           type: "nonmetal",
//           color: {
...
//     const processed = processText(inputValue);
...
//   const getCardSize = (elementCount) => {
//     if (elementCount <= 4) return "w-[140px] sm:w-[160px]";
//     if (elementCount <= 6) return "w-[120px] sm:w-[140px]";
//     if (elementCount <= 8) return "w-[100px] sm:w-[120px]";
//     if (elementCount <= 10) return "w-[80px] sm:w-[100px]";
//     return "w-[70px] sm:w-[90px]";
//   };

//   // Clear tiles after 60 seconds
//   useEffect(() => {
...
//       {/* <div className="mb-6 sm:mb-8 text-center relative max-w-xl mx-auto">
//         <input
//           type="text"
//           value={inputValue}
//           onChange={(e) => setInputValue(e.target.value)}
//           onKeyPress={handleKeyPress}
//           className="w-full p-3 sm:p-4 text-lg sm:text-xl text-white bg-[#23313F] rounded-lg focus:outline-none"
...
//                       element.color?.from || "from-gray-600"
//                     } ${
//                       element.color?.to || "to-gray-400"
//                     } rounded-lg overflow-hidden shadow-lg border border-white/10`}
//                     initial={{ opacity: 0, scale: 0.8 }}
//                     animate={{ opacity: 1, scale: 1 }}
//                     transition={{ delay: i * 0.1 }}
//                   >
//                     <SlotMachineContent element={element} index={i} />
//                   </motion.div>
//                 ))}
//               </div>
...
//                     <span
//                       key={`${element.symbol}-${i}`}
//                       className="inline-block mx-1 text-sm sm:text-base"
//                     >
//                       {element.symbol}
